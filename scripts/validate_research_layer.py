...
def main() -> int:
    ...
    parser.add_argument("--event-traceability", default="astro_research/output/reports/research_batch_v1/event_traceability.csv")
    parser.add_argument("--run-manifest", default="astro_research/output/reports/research_batch_v1/run_manifest.json")
    args = parser.parse_args()
    report, warnings = validate_research_layer(
        root=ROOT,
        output_path=ROOT / args.output,
        paths={
            "data_source_registry": "astro_research/output/parquet/source_registry/data_source_registry.parquet",
            "market_daily_features": "astro_research/output/parquet/market_daily/market_daily_features.parquet",
            "market_asset_coverage": "astro_research/output/parquet/market_daily/market_asset_coverage.parquet",
            "macro_daily_observations": "astro_research/output/parquet/macro_daily/macro_daily_observations.parquet",
            "macro_series_coverage": "astro_research/output/parquet/macro_daily/macro_series_coverage.parquet",
            ...
            "event_traceability": args.event_traceability,
            "research_run_manifest": args.run_manifest,
        },
    )
